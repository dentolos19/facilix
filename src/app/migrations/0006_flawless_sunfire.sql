...
INSERT INTO `__new_facility_events`("id", "facility_id", "device_id", "severity", "type", "message", "data", "created_at", "updated_at")
	SELECT "id", NULL, "device_id", "severity", "type", "message", "data", "created_at", "updated_at" FROM `facility_events`;--> statement-breakpoint
