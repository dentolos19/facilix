...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      className={cn(
        "scroll-fade-b scrollbar-thin scrollbar-gutter-stable size-full min-h-0 min-w-0 overflow-y-auto overscroll-contain contain-content data-autoscrolling:scrollbar-thumb-transparent data-autoscrolling:scrollbar-track-transparent",
        className,
      )}
