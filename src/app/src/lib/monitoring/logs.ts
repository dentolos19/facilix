...
export const LOG_TYPES: LogTypeDescriptor[] = [
  {
    ...
    category: "monitoring",
    description: "Cloudflare started the monitoring container process.",
    important: true,
    highVolume: false,
  },
  {
    ...
    category: "monitoring",
    description: "The container loaded its configuration and started all monitoring tasks.",
    important: true,
    highVolume: false,
  },
  {
  ...
  {
    type: "monitoring:stopping",
    label: "Monitoring stopping",
    category: "monitoring",
    description: "The monitoring service started a graceful shutdown.",
    important: true,
    highVolume: false,
  },
  {
    ...
    category: "monitoring",
    description: "Cloudflare confirmed that the monitoring container process stopped.",
    important: true,
    highVolume: false,
  },
  {
